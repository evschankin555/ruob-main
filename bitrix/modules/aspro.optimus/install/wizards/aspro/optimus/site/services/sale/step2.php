...
if(COption::GetOptionString("aspro.optimus", "wizard_installed", "N", WIZARD_SITE_ID) != "Y")
{
	$locationGroupID = 0;
	$arLocationArr = Array();
...
COption::SetOptionString("aspro.optimus", "wizard_installed", "Y", false, WIZARD_SITE_ID);
?>