...
console.log(date1);
		...
		editPaySystemInfo: function(paySystemNode)
		{
			...
			// exclude for ur person
			let selectedPersonType = this.getSelectedPersonType();

			if(selectedPersonType.ID != 2) {
		...
		editTotalBlock: function()
		{
			...
			$('.bx-soa-cart-total').append('<div class="leasing"><span class="btn btn-default button transparent btn-lg transition_bg"  onclick="widgetInit()">Купить в лизинг</span></div>');
