							...
							<div class="information inner_content js_offers__<?=$arItem['ID'];?>_list">
								...
								<div class="cost prices clearfix">
										...
										<?if (isset($arItem['MIN_PRICE']) && is_array($arItem['MIN_PRICE'])):?>
											<div class="price"><?=(isset($arItem['MIN_PRICE']['SUFFIX']) && $arItem['MIN_PRICE']['SUFFIX'] ? $arItem['MIN_PRICE']['SUFFIX'] : '')?><?=$arItem['MIN_PRICE']['PRINT_DISCOUNT_VALUE'];?></div>
										<?elseif(!empty($arItem['PRICE_MATRIX']) && is_array($arItem['PRICE_MATRIX'])):?>
											<?
											$matrix = $arItem['PRICE_MATRIX'];
											$rows = $matrix['ROWS'];
