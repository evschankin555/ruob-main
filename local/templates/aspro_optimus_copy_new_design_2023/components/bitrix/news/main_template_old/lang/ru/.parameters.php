...
$MESS["IS_VERTICAL"] = 'Отображение по колонкам';
$MESS["FAQ_FORM_ID"] = 'ИД формы';
$MESS["SHOW_SERVICES_BLOCK"] = 'Показывать блок "Заказать услугу"';
$MESS["USE_SHARE_TITLE"] = 'Показывать блок "Поделиться"';

$MESS["SLIDER_VIEW"] = 'слайдер';
$MESS["BLOCK_VIEW"] = 'блочный';
$MESS["LIST_VIEW"] = 'Вид отображения связанных товаров';
$MESS["GET_YEAR"] = 'Фильтровать элементы по годам через $_GET запрос';
