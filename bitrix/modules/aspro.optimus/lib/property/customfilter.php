<?
namespace Aspro\Optimus\Property;
...
class CustomFilter{
	...
	static function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName){
		...
		if($bDetailPage){
			if(!isset($cache)){
				$cache = array();
				$jsFile = '/bitrix/js/aspro.optimus/customfilter_control.js';
				$ajaxFile = '/bitrix/tools/aspro.optimus/customfilter_ajax.php';
								...
								'if(iv){'.
									...
									'if(td){'.
										...
										'if(tdd){'.
											...
											'}'.
										'}'.
										'initAsproOptimusCustomFilterControl({'.
											...
											'propertyParams: {'.
												...
												'JS_EVENT: \'initAsproOptimusCustomFilterControl\','.
												'AJAX_FILE: \''.$ajaxFile.'\','.
