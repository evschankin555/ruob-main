...
<?$APPLICATION->SetPageProperty("title", "Сравнение товаров | RuOborudovanie.ru");?>
<?$APPLICATION->SetPageProperty("description", "Сравнение товаров в интернет-магазине RuOborudovanie.ru. Добавьте несколько товаров для сравнения их характеристик.");
