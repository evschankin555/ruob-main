...
class SiteSettingsStep extends CSiteSettingsWizardStep{
	function InitStep(){
		if(CModule::IncludeModule("aspro.optimus")){
			...
			*/
			...
			$shopWHATSAPP = $arCurSiteTheme["SOCIAL_WHATS"];
			...
			$wizard->SetDefaultVars(
				Array(
					...
					"shopWHATSAPP" => (strlen($shopWHATSAPP) ? $shopWHATSAPP : GetMessage("WIZ_SHOP_WHATSAPP_DEF")),
	...
	function ShowStep(){
		if (!CModule::IncludeModule("aspro.optimus")){
			...
			$this->content .= '
			<div class="wizard-input-form-block">
				<label for="shopWHATSAPP" class="wizard-input-title">'.GetMessage("WIZ_SHOP_WHATSAPP").'</label><br />'
				.$this->ShowInputField('text', 'shopWHATSAPP', array("class"=>"wizard-field", "id" => "shopWHATSAPP")).'
			</div>';

			$this->content .= '
			<div class="wizard-input-form-block">
				<label for="shopSKYPE" class="wizard-input-title">'.GetMessage("WIZ_SHOP_SKYPE").'</label><br />'
				.$this->ShowInputField('text', 'shopSKYPE', array("class"=>"wizard-field", "id" => "shopSKYPE")).'
			</div>';
