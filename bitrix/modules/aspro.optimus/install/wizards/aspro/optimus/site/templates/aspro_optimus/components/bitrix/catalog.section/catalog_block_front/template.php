							...
							<div class="item_info main_item_wrapper <?=$arParams["TYPE_SKU"]?>">
									...
									<?if($arItem['OFFERS']):?>
										<div class="js_price_wrapper">
											<?if($arCurrentSKU):?>
												...
												<?else:?>
													<?\Aspro\Functions\CAsproOptimusItem::showItemPrices($arParams, $arCurrentSKU["PRICES"], $strMeasure, $min_price_id, ($arParams["SHOW_DISCOUNT_PERCENT_NUMBER"] == "Y" ? "N" : "Y"));?>
												<?endif;?>
											<?else:?>
												<?\Aspro\Functions\CAsproOptimusSku::showItemPrices($arParams, $arItem, $item_id, $min_price_id, array(), ($arParams["SHOW_DISCOUNT_PERCENT_NUMBER"] == "Y" ? "N" : "Y"));?>
											<?endif;?>
										</div>
									<?else:?>
										<?
								...
								<?if($arParams["SHOW_DISCOUNT_TIME"]=="Y"){?>
									...
									<?if($arParams['SHOW_DISCOUNT_TIME_EACH_SKU'] != 'Y' || ($arParams['SHOW_DISCOUNT_TIME_EACH_SKU'] == 'Y' && !$arItem['OFFERS'])):?>
										...
										<?endif;?>
								<?}?>
								<div class="footer_button inner_content js_offers__<?=$arItem['ID'];?>_<?=$arParams["FILTER_HIT_PROP"]?>">
									<?if($arItem["OFFERS"]){?>
