...
$APPLICATION->SetPageProperty("description", "Новости о интернет-гипермаркета промышленного оборудования RuOborudovanie.ru.");
$APPLICATION->SetPageProperty("title", "Новости | RuOborudovanie.ru");
