function initAsproOptimusCustomFilterControl(params)
{
	var data = JSON.parse(params.data);
	if (data)
	{
		window['aspro_optimus_customfilter_conditions_' + params.propertyID] = new AsproOptimusCustomFilterControl(data, params);
	}
}

function AsproOptimusCustomFilterControl(data, params)
{
...
AsproOptimusCustomFilterControl.prototype =
{
	getPath: function()
	{
