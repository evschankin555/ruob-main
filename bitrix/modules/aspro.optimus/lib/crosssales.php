<?
namespace Aspro\Optimus;
use	COptimus as Solution,
	COptimusCache as Cache,
	COptimusCondition as Condition,
	\Aspro\Optimus\Property\CustomFilter,
	\Bitrix\Main\Web\Json;

class CrossSales {
	const ALL_USERS_GROUP_ID = 2;
	const IBLOCK_TYPE = 'aspro_optimus_catalog';
	const IBLOCK_CODE = 'aspro_optimus_cross_sales';
				...
				if($propertyProductsFilterIblockId == $this->productIblockId){
					...
					if($arRulesTmp = Cache::CIBLockElement_GetList(
						...
						if($arRulesIDs){
							...
							$cachePath = '/COptimusCache/iblock/CIBlockElement_GetList/'.$cacheTag.'/';
