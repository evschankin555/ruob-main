...
$APPLICATION->SetPageProperty("description", "Справочная информация на сайте помогает посетителю ресурса быстрее найти ответы на вопросы и дает подсказки о том, как быстрее и проще сделать те или иные вещи.");
$APPLICATION->SetPageProperty("title", "Справочная информация | RuOborudovanie.ru");
...
<div class="inside_page_content">
	...
	<br />
	<div>В разделе &quot;<a href="<?=SITE_DIR?>info/articles/" >Статьи</a>&quot; Вы найдете интересные материалы о способах обращения с оборудование, которые позволят Вам быстрее выбрать нужный товар и как можно легче его использовать.</div>
	<br />
