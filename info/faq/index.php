...
$APPLICATION->SetPageProperty("description", "Вопросы и ответы о товарах компании RuOborudovanie.ru. Вы можете задать любой вопрос на тему нашей продукции или работы интеренет магазина. Мы постараемся ответить на него как можно быстрее и подробнее.");
$APPLICATION->SetPageProperty("title", "Вопрос-ответ | RuOborudovanie.ru");
