	...
	<form method="POST" name="style-switcher">
		<?if($arResult["ITEMS"] && is_array($arResult["ITEMS"])):?>
			<?foreach($arResult["ITEMS"] as $optionKey => $option):?>
				<?if($optionKey == 'CUSTOM_COLOR_THEME' || $optionKey == 'CUSTOM_BGCOLOR_THEME' || $optionKey == 'STORES_SOURCE' || $optionKey == 'NLO_MENU' || $optionKey == 'USE_LAZY_LOAD' || $optionKey == 'LOGO_IMAGE_SVG') continue;?>
				<div class="block">
